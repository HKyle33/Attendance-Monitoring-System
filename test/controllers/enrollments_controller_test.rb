...
class EnrollmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post enrollments_url, params: { enrollment: { student_id: @enrollment.student_id, subject_id: @enrollment.subject_id } }
    end
  ...
  test "should update enrollment" do
    patch enrollment_url(@enrollment), params: { enrollment: { student_id: @enrollment.student_id, subject_id: @enrollment.subject_id } }
